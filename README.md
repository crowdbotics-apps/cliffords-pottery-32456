...
## Project Structure
    ...
    ├── cliffords_pottery_32456  # Django project configurations
...
1. Clone this repo and `cd cliffords_pottery_32456`
...
2. Clone this repo and `cd cliffords_pottery_32456`
